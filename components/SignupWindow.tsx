...
export default function SignupWindow() {
	...
	return (
		<View className="px-4 py-2">
			<Text className="text-2xl font-bold text-emerald-400 mb-6 text-center">Sign Up</Text>
			...
			<TouchableOpacity className="w-full h-12 bg-gradient-to-r from-emerald-500 to-emerald-700 rounded-lg items-center justify-center mt-4" style={{ elevation: 2 }}>
				<Text className="text-emerald-50 text-lg font-semibold tracking-wide">Sign Up</Text>
			</TouchableOpacity>
		</View>
	);
}
